define(["require", "exports", "./org.data", "./org.chart"], function (require, exports, org_data_1, org_chart_1) {
    "use strict";
    // Get a reference to required org chart HTML elements.
    var _baseTreeElement = document.getElementById('tree');
    var _nodesPanelElement = document.getElementById('tree-nodes');
    var _edgesPanelElement = document.getElementById('tree-edges');
    // Get a reference to the required org breadcrumb HTML element.
    var _baseBreadcrumbElement = document.getElementById('org-breadcrumb');
    // New up an org chart with no data.
    var _orgChart = new org_chart_1.OrgChart(_baseTreeElement, _nodesPanelElement, _edgesPanelElement);
    _orgChart.setData([]);
    // New up an org breadcrumb with no data.
    var _orgBreadcrumb = new org_chart_1.OrgBreadcrumb(_baseBreadcrumbElement, _orgChart);
    ...
    _orgChart.renderedEvent.subscribe(window, function (source, args) {
    ...
    var allTreeData = org_chart_1.getTreeData(org_data_1.sampleData);
    ...
    (function () {
        ...
        var main = document.getElementById('tree');
        // Reference the mouse state.
        var mouse = { mouseDown: false, clickX: null, clickY: null };
        ...
        var mouseMoveEventHandler = function (e) {
            ...
            if (mouse.mouseDown) {
                ...
                var scrollXMultiplier = 1.6;
                var scrollYMultiplier = 1.6;
                ...
                var mouseXDelta = mouse.clickX - e.pageX;
                var scrollX_1 = (mouseXDelta) * scrollXMultiplier;
                ...
                var mouseYDelta = mouse.clickY - e.pageY;
                var scrollY_1 = (mouseYDelta) * scrollYMultiplier;
                // console.log(`x: ${scrollX}, y: ${scrollY}`);
                /* Set the content container's scrollLeft and scrollTop properties to "scroll" the content. */
                main.scrollLeft = main.scrollLeft + scrollX_1;
                main.scrollTop = main.scrollTop + scrollY_1;
    ...
    var _zoomSlider = document.getElementById('zoom-slider');
    // Function for setting an OrgChart instance's node height and width, maintaining its node's initial aspect ratio.
    var setOrgChartNodeWidthAndHeight = function (orgchart, newHeight) {
        var aspectRatio = orgchart.NODE_WIDTH / orgchart.NODE_HEIGHT;
    ...
    var setStyleSheetNodeSize = function (emFontSize) {
        var sheetToBeRemoved = document.getElementById('node-font-size');
        if (sheetToBeRemoved) {
    ...
    _zoomSlider.addEventListener('change', function (e) {
        var zoomSliderValue = parseInt(_zoomSlider.value);
    ...
    var _expandAllButton = document.getElementById('expand-all-btn');
    // Add a click handler.
    _expandAllButton.addEventListener('click', function (e) {
    ...
    var _collapseAllButton = document.getElementById('collapse-all-btn');
    // Add a click handler.
    _collapseAllButton.addEventListener('click', function (e) {
...
//# sourceMappingURL=org.main.js.map